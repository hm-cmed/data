...
namespace CodemedX.NightShift
{
    ...
    public static class ErrorKind
    {
        ...
        /// <summary>より緊急なタスクを差し置いて低緊急のタスクに着手した。</summary>
        public const string PriorityInversion = "PriorityInversion";

        /// <summary>許容時間を超えて高緊急タスクを放置した。</summary>
    ...
    /// </summary>
    public sealed class NightShiftTrainingLog
    {
        ...
        public NightShiftTrainingLog(string scenarioId, string userId)
        {
            ...
            string payloadJson = "")
        {
            ...
            if (EchoToConsole)
            {
                Debug.Log("[NightShift] " + trainingEvent.ToJson());
            }
        ...
        public string SaveToFile()
        {
            ...
            {
                Debug.LogWarning("[NightShift] ログの保存に失敗しました: " + exception.Message);
                return string.Empty;
            }
        }
