...
namespace CodemedX.Acp
{
    ...
    /// </summary>
    public sealed class AcpTrainingLog
    {
        ...
        public AcpTrainingLog(string scenarioId, string userId)
        {
            ...
            string payloadJson = "")
        {
            ...
            if (EchoToConsole)
            {
                Debug.Log("[Acp] " + trainingEvent.ToJson());
            }
        ...
        public string SaveToFile()
        {
            ...
            {
                Debug.LogWarning("[Acp] ログの保存に失敗しました: " + exception.Message);
                return string.Empty;
            }
        }
