...
namespace CodemedX.Welfare
{
    ...
    public static class EventKind
    {
        ...
        public const string CaseFileOpened = "CaseFileOpened";
    ...
    public static class ErrorKind
    {
        ...
        /// <summary>高圧的・詰問的な発言で相手を追い詰めた。</summary>
        public const string CombativeSpeech = "CombativeSpeech";

        /// <summary>重大なリスクサインを見落としたまま次の段階へ進んだ。</summary>
        public const string MissedRiskSign = "MissedRiskSign";

        /// <summary>事前資料を読まずに訪問した。</summary>
        public const string UnpreparedVisit = "UnpreparedVisit";

        /// <summary>法的要件と整合しない一時保護の判断。</summary>
        public const string UnjustifiedCustodyDecision = "UnjustifiedCustodyDecision";

        /// <summary>報告に必要な要素が欠けている。</summary>
        public const string IncompleteEscalation = "IncompleteEscalation";
    }
    ...
    /// </summary>
    public sealed class WelfareTrainingLog
    {
        ...
        public WelfareTrainingLog(string scenarioId, string userId)
        {
            ...
            string payloadJson = "")
        {
            ...
            if (EchoToConsole)
            {
                Debug.Log("[Welfare] " + trainingEvent.ToJson());
            }
        ...
        public string SaveToFile()
        {
            ...
            {
                Debug.LogWarning("[Welfare] ログの保存に失敗しました: " + exception.Message);
                return string.Empty;
            }
        }
