...
namespace CodemedX.Pharmacist
{
    ...
    public static class ErrorKind
    {
        ...
        /// <summary>疑義を確認しないまま調剤へ進んだ（薬剤師法第24条）。</summary>
    ...
    /// </summary>
    public sealed class PharmacistTrainingLog
    {
        ...
        public PharmacistTrainingLog(string scenarioId, string userId)
        {
            ...
            string payloadJson = "")
        {
            ...
            if (EchoToConsole)
            {
                Debug.Log("[Pharmacist] " + trainingEvent.ToJson());
            }
        ...
        public string SaveToFile()
        {
            ...
            {
                Debug.LogWarning("[Pharmacist] ログの保存に失敗しました: " + exception.Message);
                return string.Empty;
            }
        }
